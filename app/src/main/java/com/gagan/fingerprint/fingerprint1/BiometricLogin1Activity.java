package com.gagan.fingerprint.fingerprint1;
...
public class BiometricLogin1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_biometric_login1);
